...
// bootstrap carousel image text place below
jQuery(function ($) {
    $('.carousel').carousel();
...
function loginToRofx(){
	$('#myModal').modal('hide');
	window.open('views/redir.html');
}

function registerToRofx(){
	$('#myModal').modal('hide');
	window.open('views/redir2.html');
}

function openContactForm(){
	$('#contactmodal').modal('hide');
	window.open('/investorform');
}